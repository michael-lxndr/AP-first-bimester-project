...
public class HistorialEstadosPedido implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof HistorialEstadosPedido other)) {
			return false;
		}
		return (this.historialId != null || other.historialId == null) && (this.historialId == null || this.historialId.equals(other.historialId));
	}
