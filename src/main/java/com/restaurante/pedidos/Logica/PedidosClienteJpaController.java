...
import com.restaurante.pedidos.Clases.Entregas;
...
public class PedidosClienteJpaController implements Serializable {
    ...
    public void edit(PedidosCliente pedidosCliente) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
